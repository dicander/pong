...
function move_ball()
    ...
    elseif ball_x >= boardwidth then
        p1score = p1score + 1
        newgame()
    elseif 750-10 <= ball_x and ball_x <=750+10 and ball_x_speed >0 and p2-10 <= ball_y and ball_y <= p2+padheight then
        ball_x_speed = -ball_x_speed -1
        ball_y_speed = (p2+padheight/2 - ball_y)/10
     elseif 50-10 <= ball_x and ball_x <=50+10 and ball_x_speed < 0 and p1-10 <= ball_y and ball_y <= p1+padheight then
        ball_x_speed = -ball_x_speed + 1
